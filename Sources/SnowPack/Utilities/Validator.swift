...
public struct ProjectIdentifierValidator: ValidatorConvertible {
...
public class AgeValidator: ValidatorConvertible {
    public func validate(_ value: String) throws -> String {
...
public struct RequiredFieldValidator: ValidatorConvertible {
...
public struct UserNameValidator: ValidatorConvertible {
    public func validate(_ value: String) throws -> String {
        guard value.count >= 3 else { throw ValidationError("Username must contain more than three characters") }
        guard value.count < 16 else { throw ValidationError("Username shoudn't conain more than 16 characters") }
...
public struct PasswordValidator: ValidatorConvertible {
    public func validate(_ value: String) throws -> String {
...
public struct EmailValidator: ValidatorConvertible {
    public func validate(_ value: String) throws -> String {
        do {
...
public struct PhoneNumberValidator: ValidatorConvertible {
    
    public func validate(_ value: String) throws -> String {
        let phoneNumberKit = PhoneNumberKit()
        do {
            return try phoneNumberKit.parse(value).numberString
        } catch {
            throw ValidationError("Phone number is not valid!")
        }
    }
